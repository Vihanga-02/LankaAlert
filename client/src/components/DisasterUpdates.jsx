  ...
  return (
    <>
      <div className="mb-6">
        ...
        <div className="w-full h-64 rounded-lg border border-gray-300 bg-gray-100 flex items-center justify-center text-gray-500 italic shadow-sm">
          Google Map Placeholder - Map of Disasters Here
        </div>
      </div>
