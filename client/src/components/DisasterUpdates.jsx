...
import MapView from "./MapView"; // Import the new component

const DisasterUpdates = ({ alerts, filteredZones }) => {
  const getSeverityColor = (severity) => {
    // Use a fallback for severity if it's undefined
...
    // Use a fallback for status if it's undefined
...
        <div className="w-full h-120 rounded-lg shadow-sm border overflow-hidden">
